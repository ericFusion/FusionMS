...
function initSlider()
{
	...
	to support different sized slides you would have to write or modify a .each to correctly add widths for margin calculation. Local variable.*/	
			...
			$('div[id^="slide"]').each(function() {
  				...
  				if(($(this).attr('id') == 'slidercontainer') || ($(this).attr('id') == 'slidercontent'))
  					{
...
function updateSlider()
{
		...
		currentMargin = -(slideIndex * slideWidth);	/*Gets the current margin of the slide index times the new slide width and then animates it correctly.*/
